...
public class ProposalStatusCatalogResourceIntTest {
    ...
    @Autowired
    private ProposalStatusCatalogMapper proposalStatusCatalogMapper;
    ...
    public void setup() {
        ...
        ProposalStatusCatalogResource proposalStatusCatalogResource = new ProposalStatusCatalogResource(proposalStatusCatalogRepository, proposalStatusCatalogMapper);
    ...
    public void createProposalStatusCatalog() throws Exception {
        ...
        restProposalStatusCatalogMockMvc.perform(post("/api/proposal-status-catalogs")
            ...
            .content(TestUtil.convertObjectToJsonBytes(proposalStatusCatalogDTO)))
    ...
    public void updateProposalStatusCatalog() throws Exception {
        ...
        ProposalStatusCatalogDTO proposalStatusCatalogDTO = proposalStatusCatalogMapper.proposalStatusCatalogToProposalStatusCatalogDTO(updatedProposalStatusCatalog);
