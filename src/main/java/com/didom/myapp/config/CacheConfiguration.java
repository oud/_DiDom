...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.didom.myapp.domain.Job.class.getName() + ".skills", jcacheConfiguration);
            ...
            cm.createCache(com.didom.myapp.domain.Location.class.getName() + ".clients", jcacheConfiguration);
            cm.createCache(com.didom.myapp.domain.Location.class.getName() + ".freelancers", jcacheConfiguration);
